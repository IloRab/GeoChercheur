...
function init(){
  ...
  var lengthnom = document.getElementById("lengthnom");
  ...
  pseudo.addEventListener("input", function(){
      ...
      if(pseudo.value.length >= 3) {
        lengthnom.classList.remove("novalid");
        lengthnom.classList.add("isvalid");
      } else {
        lengthnom.classList.remove("isvalid");
        lengthnom.classList.add("novalid");
      }
